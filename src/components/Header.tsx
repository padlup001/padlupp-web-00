      ...
      <div className="max-w-4xl mx-auto px-4 py-4">
        ...
        <div className="flex items-center space-x-4">
          {!hideNavigation && onJoinWaitlistClick && (
            <Button
              onClick={handleJoin}
              className="bg-gradient-to-r from-[#4E92F4] to-[#7938BE] hover:from-[#4182E4] hover:to-[#6928AE] text-white px-4 py-2 rounded-lg shadow-md hover:shadow-lg transition-all"
            >
              Join the Waitlist
            </Button>
          )}
